...
void ntuple_maker() {
  ...
  for (int radius_counter = 0; radius_counter < number_of_radii; radius_counter++) { //RADIUS LOOP
	...
	cout << "File 2 Opened Successfully" << endl;
      ...
      if (filecounter == 2) {
	TFile *a = TFile::Open(Form("ak%iPFJetAnalyzer/outputrelresp1.root",radius)); //80 TO 100 PT AVERAGE
	...
	bin_edge_y[k] = -1.5 + (float)(0.06*k);
      ...
      TH2F*b1 = new TH2F("0.000 < |#eta| < 0.522", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*b2 = new TH2F("0.522 < |#eta| < 1.044", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*b3 = new TH2F("1.044 < |#eta| < 1.566", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*b4 = new TH2F("1.566 < |#eta| < 2.043", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*b5 = new TH2F("2.043 < |#eta| < 2.500", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*b6 = new TH2F("2.500 < |#eta| < 3.139", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
	...
	if (etaprobe < 3.139 && etaprobe > 2.500) b6->Fill(etaprobe, dijetbalanceparameter);
      ...
      TCanvas *b7 = new TCanvas("B7", Form("Separated Plots Radius = 0.%i",radius), 150, 10, 990, 660);
      b7->Divide(3,2);
      b7->cd(1);
      b1->Draw();
      b7->cd(2);
      ...
      TCanvas *b8 = new TCanvas("B8", Form("Full Plot Radius = 0.%i",radius), 150, 10, 990, 660);
      b8->cd();
      b->Draw();
      b8->Update();
      newfile->cd();
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      if (filecounter == 0) {
	TFile *d = TFile::Open(Form("ak%iPFJetAnalyzer/merged1234.root",radius)); //40 TO 60 PT AVERAGE
	cout << "MC File 1 Opened Successfully" << endl;
      }
      if (filecounter == 1) {
	TFile *d = TFile::Open(Form("ak%iPFJetAnalyzer/merged123.root",radius)); //60 TO 80 PT AVERAGE
	cout << "MC File 2 Opened Successfully" << endl;
      }
      if (filecounter == 2) {
	TFile *d = TFile::Open(Form("ak%iPFJetAnalyzer/balancemcouta.root",radius)); //80 TO 100 PT AVERAGE
	cout << "MC File 3 Opened Successfully" << endl;
      }
      if (filecounter == 3) {
	TFile *d = TFile::Open(Form("ak%iPFJetAnalyzer/merged.root",radius)); // 100 TO 140 PT AVERAGE
	cout << "MC File 4 Opened Successfully" << endl;
      }
      if (filecounter == 4) {
	TFile *d = TFile::Open(Form("ak%iPFJetAnalyzer/merged12.root",radius)); //140 TO 200 PT AVERAGE
	cout << "MC File 5 Opened Successfully" << endl;
      ...
      // Int_t bins_y = sizeof(bin_edge_y)/sizeof(Float_t) - 1;
      TH2F*c = new TH2F("c", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      c->Sumw2();
      //SPLITTING APART THE DATA INTO MULTIPLE ETA RANGES
      TH2F*c1 = new TH2F("0.000 < |#eta| < 0.522", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*c2 = new TH2F("0.522 < |#eta| < 1.044", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*c3 = new TH2F("1.044 < |#eta| < 1.566", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*c4 = new TH2F("1.566 < |#eta| < 2.043", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*c5 = new TH2F("2.043 < |#eta| < 2.500", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
      TH2F*c6 = new TH2F("2.500 < |#eta| < 3.139", Form("B vs. Eta Radius = 0.%i; Eta; B",radius), binnum, cms_hcal_edge_pseudorapidity, bins_y, bin_edge_y);
	...
	if (etaprobemc < 3.139 && etaprobemc > 2.500) c6->Fill(etaprobemc, dijetbalanceparametermc);
      ...
      TCanvas *c7 = new TCanvas("C7", Form("Separated Plots Radius = 0.%i",radius), 150, 10, 990, 660);
      c7->Divide(3,2);
      c7->cd(1);
      c1->Draw();
      c7->cd(2);
      ...
      TCanvas *c8 = new TCanvas("C8", Form("Full Plot Radius = 0.%i",radius), 150, 10, 990, 660);
      c8->cd();
      c->Draw();
      c8->Update();
      newfile->cd();
    ...
    casympt0->SetTitle(Form("p_{T} Dependent Correction |#eta| < 3.139 Radius = 0.%i",radius));
    ...
    casympt1->SetTitle(Form("p_{T} Dependent Correction |#eta| < 0.522 Radius = 0.%i",radius));
    ...
    casympt2->SetTitle(Form("p_{T} Dependent Correction 0.522 < |#eta| < 1.044 Radius = 0.%i",radius));
    ...
    casympt3->SetTitle(Form("p_{T} Dependent Correction 1.044 < |#eta| < 1.566 Radius = 0.%i",radius));
    ...
    casympt4->SetTitle(Form("p_{T} Dependent Correction 1.566 < |#eta| < 2.043 Radius = 0.%i",radius));
    ...
    casympt5->SetTitle(Form("p_{T} Dependent Correction 2.043 < |#eta| < 2.500 Radius = 0.%i",radius));
    ...
    casympt6->SetTitle(Form("p_{T} Dependent Correction 2.500 < |#eta| < 3.139 Radius = 0.%i",radius));
