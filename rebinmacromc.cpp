...
void rebinmacromc() {
  ...
  for (int radius_counter = 1; radius_counter <= 7; radius_counter++) { //RADIUS LOOP 
    for (int filecounter = 0; filecounter < 5; filecounter++) { //FILE LOOP
      if (filecounter == 0) {
	TFile *MyFile1 = new TFile(Form("ak%iPFJetAnalyzer/balancemcout1234.root",radius_counter), "Read"); // 40 TO 60 PT AVERAGE
	...
	TFile *MyFile2 = new TFile(Form("ak%iPFJetAnalyzer/balancemcout21234.root",radius_counter), "Read"); // 40 TO 60 PT AVERAGE
	...
	TFile *rebinfile = new TFile(Form("ak%iPFJetAnalyzer/rebinoutmc1234.root",radius_counter), "Recreate"); // 40 TO 60 PT AVERAGE
      }
      if (filecounter == 1) {
	TFile *MyFile1 = new TFile(Form("ak%iPFJetAnalyer/balancemcout123.root",radius_counter), "Read"); // 60 TO 80 PT AVERAGE
	if (MyFile1->IsOpen()) printf("File Opened Successfully.\n");
	gFile = MyFile1;
	MyFile1->ls();
	TH1F *balance1 = (TH1F *)MyFile1->Get("balance");
	TH1F *outereta1 = (TH1F *)MyFile1->Get("outereta");
	TH1F *innereta1 = (TH1F *)MyFile1->Get("innereta");
	TFile *MyFile2 = new TFile(Form("ak%iPFJetAnalyzer/balancemcout2123.root",radius_counter), "Read"); // 60 TO 80 PT AVERAGE
	if (MyFile2->IsOpen()) printf("File 2 Opened Successfully.\n");
	MyFile2->ls();
	TH1F *balance2 = (TH1F *)MyFile2->Get("balance");
	TH1F *outereta2 = (TH1F *)MyFile2->Get("outereta");
	TH1F *innereta2 = (TH1F *)MyFile2->Get("innereta");
	TFile *rebinfile = new TFile(Form("ak%iPFJetAnalyzer/rebinoutmc123.root",radius_counter), "Recreate"); // 60 TO 80 PT AVERAGE
      }
      if (filecounter == 2) {
	TFile *MyFile1 = new TFile(Form("ak%iPFJetAnalyzer/balancemcouta.root",radius_counter), "Read"); // 80 TO 100 PT AVERAGE
	if (MyFile1->IsOpen()) printf("File Opened Successfully.\n");
	gFile = MyFile1;
	MyFile1->ls();
	TH1F *balance1 = (TH1F *)MyFile1->Get("balance");
	TH1F *outereta1 = (TH1F *)MyFile1->Get("outereta");
	TH1F *innereta1 = (TH1F *)MyFile1->Get("innereta");
	TFile *rebinfile = new TFile(Form("ak%iPFJetAnalyzer/rebinoutmc1.root",radius_counter), "Recreate"); // 80 TO 100 PT AVERAGE
      }
      if (filecounter == 3) {
	TFile *MyFile1 = new TFile(Form("ak%iPFJetAnalyzer/balancemcout.root",radius_counter), "Read"); // 100 TO 140 PT AVERAGE
	if (MyFile1->IsOpen()) printf("File Opened Successfully.\n");
	gFile = MyFile1;
	MyFile1->ls();
	TH1F *balance1 = (TH1F *)MyFile1->Get("balance");
	TH1F *outereta1 = (TH1F *)MyFile1->Get("outereta");
	TH1F *innereta1 = (TH1F *)MyFile1->Get("innereta");
	TFile *MyFile2 = new TFile(Form("ak%iPFJetAnalyzer/balancemcout2.root",radius_counter), "Read"); // 100 TO 140 PT AVERAGE
	if (MyFile2->IsOpen()) printf("File 2 Opened Successfully.\n");
	MyFile2->ls();
	TH1F *balance2 = (TH1F *)MyFile2->Get("balance");
	TH1F *outereta2 = (TH1F *)MyFile2->Get("outereta");
	TH1F *innereta2 = (TH1F *)MyFile2->Get("innereta");
	TFile *rebinfile = new TFile(Form("ak%iPFJetAnalyzer/rebinoutmc.root",radius_counter), "Recreate"); // 100 TO 140 PT AVERAGE
      }
      if (filecounter == 4) {
	TFile *MyFile1 = new TFile(Form("ak%iPFJetAnalyzer/balancemcout12.root",radius_counter), "Read"); // 140 TO 200 PT AVERAGE
	if (MyFile1->IsOpen()) printf("File Opened Successfully.\n");
	gFile = MyFile1;
	MyFile1->ls();
	TH1F *balance1 = (TH1F *)MyFile1->Get("balance");
	TH1F *outereta1 = (TH1F *)MyFile1->Get("outereta");
	TH1F *innereta1 = (TH1F *)MyFile1->Get("innereta");
	TFile *MyFile2 = new TFile(Form("ak%iPFJetAnalyzer/balancemcout212.root",radius_counter), "Read"); // 140 TO 200 PT AVERAGE
	if (MyFile2->IsOpen()) printf("File 2 Opened Successfully.\n");
	MyFile2->ls();
	TH1F *balance2 = (TH1F *)MyFile2->Get("balance");
	TH1F *outereta2 = (TH1F *)MyFile2->Get("outereta");
	TH1F *innereta2 = (TH1F *)MyFile2->Get("innereta");
	TFile *rebinfile = new TFile(Form("ak%iPFJetAnalyzer/rebinoutmc12.root",radius_counter), "Recreate"); // 140 TO 200 PT AVERAGE
      }
	...
	//outeretarebin->Fill(integral2);
      ...
      balancerebinmc->SetTitle(Form("Rebin Full Eta Range Radius = 0.%i", radius_counter));
      ...
      inneretarebinmc->SetTitle(Form("Rebin Inner Eta Range Radius = 0.%i", radius_counter));
      ...
      outeretarebinmc->SetTitle(Form("Rebin Outer Eta Range Radius = 0.%i", radius_counter));
