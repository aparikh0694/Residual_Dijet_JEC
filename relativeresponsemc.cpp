...
TH1D*h1[84];
  ...
  for (int filecounter = 0; filecounter < 5; filecounter++) { //FILE LOOP
    if (filecounter == 0) {
      TFile *a = TFile::Open("merged1234.root"); // 40 TO 60 PT AVERAGE
      TFile *relresp = new TFile("relativeresponsemc1234.root", "Recreate"); // 40 TO 60 PT AVERAGE
      cout << "File 1 Opened Successfully" << endl;
    }
    if (filecounter == 1) {
      TFile *a = TFile::Open("merged123.root"); // 60 TO 80 PT AVERAGE 
      TFile *relresp = new TFile("relativeresponsemc123.root", "Recreate"); // 60 TO 80 PT AVERAGE
      cout << "File 2 Opened Successfully" << endl;
    }
    if (filecounter == 2) {
      TFile *a = TFile::Open("balancemcouta.root"); //80 TO 100 PT AVERAGE
      TFile *relresp = new TFile("relativeresponsemc1.root", "Recreate"); // 80 TO 100 PT AVERAGE
      cout << "File 3 Opened Successfully" << endl;
    }
    if (filecounter == 3) {
      TFile *a = TFile::Open("merged.root"); // 100 TO 140 PT AVERAGE
      TFile *relresp = new TFile("relativeresponsemc.root", "Recreate"); // 100 TO 140 PT AVERAGE
      cout << "File 4 Opened Successfully" << endl;
    }
    if (filecounter == 4) {
      TFile *a = TFile::Open("merged12.root"); // 140 TO 200 PT AVERAGE
      TFile *relresp = new TFile("relativeresponsemc12.root", "Recreate"); // 140 TO 200 PT AVERAGE
