...
void dijetbalancemc()	{
  for (int filecounter = 0; filecounter < 5; filecounter++) { //FILE LOOP	
    ...
    if (filecounter == 0) {
      ...
      if (pt->IsOpen()) pt->ls();
      TFile *balancemcout = new TFile("balancemcout1234.root", "recreate"); // 40 TO 60 PT AVERAGE
    ...
    if (filecounter == 1) {
      ...
      if (pt->IsOpen()) pt->ls();
      TFile *balancemcout = new TFile("balancemcout123.root", "recreate"); // 60 TO 80 PT AVERAGE
    ...
    if (filecounter == 2) {
      ...
      if (pt->IsOpen()) pt->ls();
      TFile *balancemcout = new TFile("balancemcouta.root", "recreate"); // 80 to 100 PT AVERAGE
      cout << "File 3 Opened Successfully" << endl;
    }
    if (filecounter == 3) {
      TFile *pt = TFile::Open("/afs/cern.ch/user/g/gpikul/work/public/pt80_pp2013_P01_prod22_v81_merged_forest_0.root"); // 80 TO 140 PT AVERAGE
      if (pt->IsOpen()) pt->ls();
      TFile *balancemcout = new TFile("balancemcout.root", "recreate"); // 100 TO 140 PT AVERAGE
    ...
    if (filecounter == 4) {
      ...
      if (pt->IsOpen()) pt->ls();
      TFile *balancemcout = new TFile("balancemcout12.root", "recreate"); // 140 TO 200 PT AVERAGE
